...
**如果TCP断开连接，B处于LAST_ACK阶段，一直收不到A的ACK，B的状态会怎么变化？**

- 正常状态下，B收到A的ACK，然后进入到CLOSED状态
- 异常状态下，如果因为某些原因，B没有收到A的ACK，会触发超时重传机制，B会重新发送一个FIN
  - 

[在tcp协议中处于last_ack状态的连接，如果一直收不到对方的ack，会一直处于这个状态吗？ - 知乎 (zhihu.com)](https://www.zhihu.com/question/27564314)
...
- 有最大1024个文件描述符的限制（可以修改宏FD_SETSIZE，但需要重新编译内核，操作比较麻烦）
